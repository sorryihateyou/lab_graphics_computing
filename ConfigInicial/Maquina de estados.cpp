...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion maquina de estados - Diego Del Razo", nullptr, nullptr);
...
void Animation() {
	...
	if (dogAnim == 1) {		// Walk animation
		...
		if (dogPos.z + 0.00025 < 2.35f) {	//Continua hasta llegar al borde 
			dogPos.z += 0.00025;
		}
		else {
			// Se termina cuando concluye la distancia recorrida
			dogAnim = 0;
		}
	}
