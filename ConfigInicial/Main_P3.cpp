...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Proyecciones, transformaciones y Shaders - Diego Del Razo", nullptr, nullptr);
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
	   ...
	   view = glm::translate(view, glm::vec3(0.0f,0.0f,-25.0f));
		...
		//model = glm::rotate(model, 1.57f, glm::vec3(0.0f, 0.0f, 0.5f)); // use to compare orthographic and perspective projection
		//model = glm::scale(model, glm::vec3(8.0f, 1.0f, 5.0f));
		//glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		//glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::rotate(model, 1.57f, glm::vec3(0.15f, -2.5f, -0.05f)); // use to compare orthographic and perspective projection
		...
		model = glm::rotate(model, 3.1416f, glm::vec3(0.0f, 0.8f, -0.7f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(5.0f, 5.0f, 5.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::rotate(model, 3.2f, glm::vec3(0.0f, 0.15f, 0.03f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(5.0f, 5.0f, 5.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(3.0f, 5.0f, 0.0f));
		model = glm::rotate(model, 8.2f, glm::vec3(0.05f, 0.0f, 0.0f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(5.0f, 5.0f, 5.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
